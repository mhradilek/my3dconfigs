...
#define STRING_CONFIG_H_AUTHOR "Miroslav Hradilek" // Who made the changes.
...
#define MACHINE_UUID "ea18c5e5-f8c3-4c58-8d03-ef531dc398da"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,468}  // My settings: (200*16) * (49/15.0)/(7.5 * math.pi); then several corrections: new_e_steps = old_e_steps * (100 / distance_actually_moved)
